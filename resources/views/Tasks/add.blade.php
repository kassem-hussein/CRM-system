...
<div class="flex gap-1 items-center p-4">
    ...
    <a class="history">{{__('messages.add_task')}}</a>
</div>
<form class="p-4" action="/tasks" method="post">
    @csrf
    ...
    <div class="flex flex-col my-1">
        ...
        <input type="datetime-local" id="start_date" value="{{old('start_date')}}" name="start_date" placeholder="{{__('messages.start_date')}}"/>
    ...
    <div class="flex flex-col my-1">
        ...
        <input type="datetime-local" id="end_date" value="{{old('end_date')}}" name="end_date" placeholder="{{__('messages.end_date')}}"/>
    ...
    <div class="flex flex-col my-1">
        ...
        <select name="status" id="status">
            <option value="in progress">{{__('messages.in progress')}}</option>
            <option value="done">{{__('messages.done')}}</option>
            <option value="cancled">{{__('messages.cancled')}}</option>
        </select>
    </div>
