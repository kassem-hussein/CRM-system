...
@section('content')
    <div class="flex gap-1 items-center p-4">
        ...
        <a class="history">{{__('messages.edit_customer')}}</a>
    </div>
    <form  class="p-4" action="/customers/{{$customer->id}}" method="post">
        @csrf
        <div class="flex flex-col my-1">
            <label for="name" required>{{__('messages.name')}}</label>
            <input type="text" id="name" value="{{$customer->name}}" name="name" placeholder="{{__('messages.name')}}"/>
            @if ($errors->has('name'))
        ...
        <div class="flex flex-col my-1">
            ...
            <input type="text" id="phone" value="{{$customer->phone}}" name="phone" placeholder="{{__('messages.phone')}}"/>
            @if ($errors->has('phone'))
        ...
        <div class="flex flex-col my-1">
            ...
            <input type="email" id="email" value="{{$customer->email}}" name="email" placeholder="{{__('messages.email')}}"/>
            @if ($errors->has('email'))
        ...
        <div class="flex flex-col my-1">
            ...
            <input type="text" id="address" name="address" value="{{$customer->address}}" placeholder="{{__('messages.address')}}">
